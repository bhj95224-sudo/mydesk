...
// Ported from reactbits.dev/micro/lattice-loader.
...
const PATTERNS: Partial<Record<PatternName, Partial<Record<3 | 4, ResolvedPattern>>>> = {
...
const DEFAULT_PATTERN: Record<3 | 4, PatternName> = { 3: 'orbit', 4: 'sweep' };
...
function resolvePattern(pattern: PatternName | CustomPattern, grid: 3 | 4): ResolvedPattern {
  if (typeof pattern === 'string') {
    const named = PATTERNS[pattern];
    return named?.[grid] ?? PATTERNS[DEFAULT_PATTERN[grid]]![grid]!;
  }
